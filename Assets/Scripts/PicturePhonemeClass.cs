...
public class PicturePhonemeClass : MonoBehaviour
{
    public Texture2D image;
    private string imageName = "ImageName";
    private string assignment = "Første Lyd i ordet";
    private string assignmentLetter = "Letter";
    ...
    public PicturePhonemeClass(Texture2D image)
    {
        this.image = image;
    }
    ...
    public void SetAssignmentLetter(string letter)
    { this.assignmentLetter = letter; }
    public string GetAssignmentLetter()
        { return this.assignmentLetter; }
