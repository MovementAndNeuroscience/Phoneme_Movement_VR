...
public class PhonemeDb : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        øClass.SetLeftHandPos1(new Vector3(0.16f, 1.355f, targetZPos));
        øClass.SetLeftHandAngle1(new Vector3(0f, 0f, 90f));
        øClass.SetRightHandPos1(new Vector3(-0.028f, 1.356f, targetZPos));
        ...
        åClass.SetLeftHandPos1(new Vector3(0.1219f, 1.528f, targetZPos));
        åClass.SetLeftHandPos2(new Vector3(0.049f, 1.528f, targetZPos));
        åClass.SetLeftHandPos3(new Vector3(0.1219f, 1.528f, targetZPos));
        åClass.SetLeftHandPos4(new Vector3(0.049f, 1.528f, targetZPos));
        ...
        åClass.SetRightHandPos1(new Vector3(-0.126f, 1.528f, targetZPos));
        åClass.SetRightHandPos2(new Vector3(-0.056f, 1.528f, targetZPos));
        åClass.SetRightHandPos3(new Vector3(-0.126f, 1.528f, targetZPos));
        åClass.SetRightHandPos4(new Vector3(-0.056f, 1.528f, targetZPos));
